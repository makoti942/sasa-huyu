                        ...
                        <div className='ou-modal__content'>
                            {[
                                ...
                                { c: 'cyan', t: 'Rise / Fall V2', items: [
                                    '<b>Goal:</b> Enter trades on sustained MACD histogram momentum using mean reversion — overbought/oversold reversals.',
                                    ...
                                    '<b>RISE (CALL) Entry — Overbought Reversion:</b> The histogram must be <b>above zero</b> and each bar must be <b>higher than the previous</b> for 4 consecutive ticks. On the 4th consecutive increase in upward momentum, the price is overbought → place a <b>RISE</b> contract expecting reversal.',
                                    '<b>FALL (PUT) Entry — Oversold Reversion:</b> The histogram must be <b>below zero</b> and each bar must be <b>more negative</b> than the previous for 4 consecutive ticks. On the 4th consecutive increase in downward momentum, the price is oversold → place a <b>FALL</b> contract expecting reversal.',
